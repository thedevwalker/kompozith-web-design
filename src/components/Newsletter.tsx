  ...
  return (
    <div className="flex flex-col space-y-4 max-w-sm w-full" id="newsletter-block">
      <div>
        ...
        <p className="text-slate-600 text-sm font-light mt-1 leading-relaxed">
      ...
      <form onSubmit={handleSubmit} className="relative w-full" id="newsletter-form">
        <div className="relative flex items-center">
          <input
            ...
            className="w-full bg-white text-slate-800 placeholder-slate-400 text-sm font-light pl-5 pr-14 py-3.5 rounded-full border border-slate-200 focus:border-[#ff4e17] focus:outline-none focus:ring-2 focus:ring-[#ff4e17]/10 transition-all duration-300 shadow-2xs"
          />
        ...
        {status === "success" && (
          <div className="flex items-center gap-1.5 mt-2 text-xs text-emerald-600 pl-3 animate-fade-in font-medium">
